...
export const GetValidatorSetByHeightResponse = {
  ...
  fromJSON(object: any): GetValidatorSetByHeightResponse {
    return {
      block_height: isSet(object.block_height)
        ? Long.fromString(object.block_height)
        : Long.ZERO,
  ...
  toJSON(message: GetValidatorSetByHeightResponse): unknown {
    ...
    message.block_height !== undefined &&
      (obj.block_height = (message.block_height || Long.ZERO).toString());
...
export const Validator = {
  ...
  toJSON(message: Validator): unknown {
    ...
    message.voting_power !== undefined &&
      (obj.voting_power = (message.voting_power || Long.ZERO).toString());
    message.proposer_priority !== undefined &&
      (obj.proposer_priority = (
        message.proposer_priority || Long.ZERO
      ).toString());
    return obj;
  },
  ...
  fromJSON(object: any): GetBlockByHeightResponse {
    return {
      ...
      sdk_block: isSet(object.sdk_block)
        ? Block2.fromJSON(object.sdk_block)
        : undefined,
    };
  },
  ...
  toJSON(message: GetBlockByHeightResponse): unknown {
    ...
    message.sdk_block !== undefined &&
      (obj.sdk_block = message.sdk_block
        ? Block2.toJSON(message.sdk_block)
        : undefined);
    return obj;
  },
  ...
  fromPartial(
    ...
    message.sdk_block =
      object.sdk_block !== undefined && object.sdk_block !== null
        ? Block.fromPartial(object.sdk_block)
        : undefined;
    return message;
  },
};
